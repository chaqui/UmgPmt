package com.vista.jsf;

import com.modulos.persistencia.Remision;
import com.vista.jsf.util.JsfUtil;
import com.vista.jsf.util.PaginationHelper;
import com.controladores.beans.RemisionFacade;
...
@ManagedBean(name = "remisionController")
@SessionScoped
public class RemisionController implements Serializable {
    ...
    public String prepareView() {
        current = (Remision) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("RemisionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("RemisionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("RemisionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class RemisionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Remision) {
                ...
                return getStringKey(o.getNoRemision());
            } else {
